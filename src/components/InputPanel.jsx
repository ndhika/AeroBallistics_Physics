...
export default function InputPanel({ params, onStart, onReset, isRunning, onParamChange, onClose }) {
    ...
    return (
        <div className="bg-white/90 backdrop-blur-md rounded-xl shadow-lg border border-white/50 overflow-hidden flex flex-col ring-1 ring-black/5 max-h-[calc(200vh-80px)]">
